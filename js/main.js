...
new Swiper('.awards .swiper-container', {
  ...
  spaceBetween: 30,
  autoplay: {
    delay: 3000, //5초에 한번씩 슬라이드
    disableOnInteraction: false // 버튼 클릭후에도 자동재생하기 위한 옵션
  },
  loop: true,
  navigation: {
...
// scrollMagic cdn 화면에 보이면 애니메이션 시작
const spyEls = document.querySelectorAll('section.scroll-spy');
spyEls.forEach(function(spyEl){
  new ScrollMagic
    .Scene({
      triggerElement: spyEl, //보여짐 여부를 감시할 요소를 지정
      triggerHook: .8 // 뷰포트 상0 ~ 하1
    })
